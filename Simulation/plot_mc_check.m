...
% PLOT_MC_CHECK  Compare MC simulated increments against the FFT-reconstructed
%   CDF/PDF (pdf on linear and log-y scales, plus a binning-free CDF overlay).
%
% INPUTS:
...
% OUTPUT:
%   none (draws a 3-panel comparison figure)
