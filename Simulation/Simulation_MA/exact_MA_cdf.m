function exact_cdf = exact_MA_cdf(pt_plus, pt_minus, ps_plus, ps_minus, drift, x_grid)
%EXACT_MA_CDF Computes and plots the analytical CDF of a Minimal Additive increment.
%   EXACT_CDF = EXACT_MA_CDF(PT_PLUS, PT_MINUS, PS_PLUS, PS_MINUS, DRIFT, X_GRID)
