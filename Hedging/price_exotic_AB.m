function V = price_exotic_AB(type, params_AB, scale_factor, mkt, mc)
    ...
    switch upper(type)
        case 'COC'
            ...
            V = CoC_pricing_MC(params_AB, scale_factor, mc.N_sim, mc.M, mc.dz, ...
                    mc.N_grid, mkt.forward, mkt.K1, mkt.K2, mkt.df, model, false);
        ...
        case 'CHOOSER'
            ...
            V = Chooser_pricing_MC(params_AB, scale_factor, mc.N_sim, mc.M, mc.dz, ...
                    mc.N_grid, mkt.forward, mkt.K2, mkt.df, model, false);
