...
% OBJECTIVE_FUNCTION_AB  SSE between AB model and market call prices (fmincon).
%   Prices the whole (M x N) surface via price_AB, sums squared residuals over
%   quoted points only (NaNs ignored), and penalizes model failures.
%
% INPUTS:
%   x         : [k, eta]
